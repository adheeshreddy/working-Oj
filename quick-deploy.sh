...
# 🚀 Quick Deploy Script for AlgoNest
# This script provides step-by-step deployment commands

echo "🚀 AlgoNest Quick Deployment Guide"
echo "=================================="
echo ""

echo "📋 Step 1: Prepare Frontend for Netlify"
echo "----------------------------------------"
echo "cd frontend"
echo "npm install"
echo "npm run build"
...
echo "📋 Step 4: Clone and Setup Backend"
echo "-----------------------------------"
echo "git clone https://github.com/yourusername/algonest.git"
echo "cd algonest/backend"
echo "npm install"
echo ""
...
echo "MONGO_URI=mongodb+srv://username:password@cluster.mongodb.net/algonest"
echo "PORT=5000"
...
echo "--------------------------------"
echo "pm2 start server.js --name 'algonest-backend'"
echo "pm2 save"
echo "pm2 startup"
echo ""

echo "📋 Step 7: Setup Compiler Service"
echo "---------------------------------"
echo "cd ../compiler"
echo "npm install"
echo "pm2 start index.js --name 'algonest-compiler'"
echo "pm2 save"
echo ""
...
echo "📋 Step 9: Setup SSL (Optional)"
echo "--------------------------------"
echo "sudo apt install -y certbot python3-certbot-nginx"
echo "sudo certbot --nginx -d your-ec2-domain.com"
echo ""

echo "📋 Step 10: Test Deployment"
echo "----------------------------"
